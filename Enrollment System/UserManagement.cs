...
namespace Enrollment_System
{
    public partial class UserManagement : Form
    {
        ...
        private void LoadData()
        {
            ...
            stringBuilder.AppendLine("  FROM [IT3232Javellana].[stud].[UserAccount]");
            ...
            try
            {
                ...
                dataGridViewUserManagementList.DataSource = dataTable;
        ...
        private void dataGridViewUserManagementList_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                DataGridViewRow selectedRow = dataGridViewUserManagementList.Rows[e.RowIndex];
        ...
        private void tbSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(GlobalSetting.ConnectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand())
                {
                    ...
                    dataGridViewUserManagementList.DataSource = searchResults;
                }
        ...
        {
            if (dataGridViewUserManagementList.SelectedRows.Count > 0)
            {
                int selectedIndex = dataGridViewUserManagementList.SelectedRows[0].Index;

                string ID = dataGridViewUserManagementList.Rows[selectedIndex].Cells["UserID"].Value.ToString();
