...
namespace Enrollment_System
{
    public partial class Section : Form
    {
        ...
        private void LoadData()
        {
            ...
            stringBuilder.AppendLine("  FROM [IT3232Javellana].[dbo].[Section]");
            ...
            try
            {
                ...
                dataGridViewSection.DataSource = dataTable;
                dataGridViewSection.Columns["SectionID"].Visible = false;
        ...
        private void dataGridViewSection_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                SectionID = Convert.ToInt32(selectedRow.Cells[0].Value.ToString());
        ...
        {
            if (dataGridViewSection.SelectedRows.Count > 0)
            {
                int selectedIndex = dataGridViewSection.SelectedRows[0].Index;

                string ID = dataGridViewSection.Rows[selectedIndex].Cells["SectionID"].Value.ToString();
        ...
        private void SearchSection()
        {
            ...
            using (SqlConnection connection = new SqlConnection(GlobalSetting.ConnectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand())
                {
                    ...
                    dataGridViewSection.DataSource = searchResults;
                }
            }
        }
